 ...
 ********************************************************************
 * Local data types of program mc_axis
 ********************************************************************)
...
TYPE
	...
	ParID_Read_typ : 	STRUCT 
		...
		actLimitTorque : REAL;
		tempJunction : REAL;
		effectivePower : REAL; (*Albert*)
		consumedEnergy : REAL; (*Albert*)
	END_STRUCT;
	PID_Par_typ : 	STRUCT 
		kv_p : REAL;
		tn_p : REAL;
...
TYPE
	Energy_Par_typ : 	STRUCT 
		TriggerCarriage : USINT;
	END_STRUCT;
END_TYPE
